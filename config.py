...
class Configuracion:
    ...
    WEBPAY_ONECLICK_PARENT_COMMERCE_CODE = os.getenv("WEBPAY_ONECLICK_PARENT_COMMERCE_CODE")
    WEBPAY_ONECLICK_CHILD_COMMERCE_CODE = os.getenv("WEBPAY_ONECLICK_CHILD_COMMERCE_CODE")
